...
/** Spring bean factory that produces {@link SortedLdapNameAttributeDefinition}s. */
public class SortedLdapNameAttributeDefinitionFactoryBean extends BaseAttributeDefinitionFactoryBean {

    /** {@inheritDoc} */
    protected Object createInstance() throws Exception {
        SortedLdapNameAttributeDefinition definition = new SortedLdapNameAttributeDefinition();
