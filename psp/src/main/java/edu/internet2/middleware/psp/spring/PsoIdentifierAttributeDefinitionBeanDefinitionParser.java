...
import edu.internet2.middleware.psp.shibboleth.PsoIdentifierAttributeDefinition;
...
public class PsoIdentifierAttributeDefinitionBeanDefinitionParser extends BaseAttributeDefinitionBeanDefinitionParser {
    ...
    /** Schema type name. */
    public static final QName TYPE_NAME = new QName(PspNamespaceHandler.NAMESPACE, "PSOIdentifier");
