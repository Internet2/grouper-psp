...
import edu.internet2.middleware.psp.shibboleth.SimpleAttributeAuthority;
...
public class SimpleAttributeAuthorityBeanDefinitionParser extends AbstractServiceBeanDefinitionParser {
  ...
  /** schema type name. */
  public static final QName TYPE_NAME = new QName(PspNamespaceHandler.NAMESPACE, "SimpleAttributeAuthority");
