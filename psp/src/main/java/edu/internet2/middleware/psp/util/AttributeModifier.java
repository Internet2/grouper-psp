 ...
 * <ol>
 * <li>Initialize it with the current values stored in the attribute to be modified. If the current attribute is empty,
 * call {@link #init(Attribute)} passing <code>null</code> . Otherwise call {@link #init(Attribute)} passing an
 * Attribute holding the current set of values. <br>
 * <li>For each value the attribute is to hold, call {@link #store(String)} passing the value. The AttributeModifier
 * determines whether or not the value is an existing value that must remain or is a new value to be added to the
 * attribute.<br>
 * <li>After storing all of the values to be included in the attribute, call {@link #getModifications()} to generate an
 * array of {@link javax.naming.directory.ModificationItem}s that can be used to update the directory. Applying these
 * modifications will result in the attribute holding the desired set of values.
 * </ol>
 * Note that if no values are stored, the modifications generated by AttributeModifier will result in the attribute
 * holding no values. This may not be acceptable for example if the attribute is a <i>MUST</i> attribute. To ensure the
 * generated modifications will always result in the attribute holding a value, the AttributeModifier supports a <i>no
 * value</i>. If the <i>no value</i> is set to a non-null String and no values are stored, the generated modifications
 * will result in attribute holding just the <i>no value</i>.
 * <p>
 ...
 * <li>The attribute in the directory has not been modified prior to applying the generated modifications.
 * </ul>
 * 
 */
public class AttributeModifier {
    ...
    /**
     * "no value" value. This is used when the attribute is required, but there are no values to be included.
     */
    ...
    /**
     * Constructs an <code>AttributeModifier</code> for the attribute name. This AttributeModifier is case insensitive
     * and assumes the attribute is not required as the "no value" is not defined.
     * 
    ...
    /**
     * Constructs an <code>AttributeModifier</code> for the attribute name with the given "no value" value. This
     * AttributeModifier is case insensitive.
     * 
     * @param attributeName Name of the attribute
     * @param noValue "no value" value (null if the attribute is not required).
     */
    ...
    /**
     * Constructs an <code>AttributeModifier</code> for the attribute name with the case sensitivity for string
     * comparisions set as given. it is assumed that the attribute is not required as the "no value" is not defined.
     * 
     * @param attributeName Name of the attribute
     * @param caseSensitive boolean indicating if attribute value comparisions are case sensitive.
     */
    ...
    /**
     * Constructs an <code>AttributeModifier</code> for the attribute name with the given "no value" value and case
     * sensitivity.
     * 
     * @param attributeName Name of the attribute
     * @param noValue "no value" value (null if the attribute is not required).
    ...
    /**
     * Gets the "no value" value. If not <code>null</code>, this value is stored in the attribute when the modifications
     * identified here would result in the attribute having no values.
     * 
    ...
    /**
     * Set the "no value" value. If not <code>null</code>, this value is stored in the attribute when the modifications
     * identified here would result in the attribute having no values.
     * 
     * @param noValue "no value" string, or <code>null</code> if the attribute is not required to have values.
     */
    ...
    /**
     * Set the case sensitive flag. This determines if attribute value comparisons are case sensitive or not.
     * 
    ...
    /**
     * Initializes this with the values from the given attribute. This clears any pre-existing values, and populates it
     * with the given list of values.
     * 
     * @param attribute Attribute
     * @throws NamingException thrown if an error occurs accessing the attribute values
     * @throws javax.naming.directory.InvalidAttributeValueException thrown if a non-String value is encountered
     */
    ...
    /**
     * Initializes this with the values from the given collection. This clears any pre-existing values, and populates it
     * with the given list of values.
     * 
     * @param collection Initial values
     */
    ...
    /**
     * Stores the attribute value. This identifies the value as one that must either remain from the original set or be
     * added to the attribute.
     * 
     * @param attrValue Attribute value
     * @throws NamingException thrown if a naming exception occurs
     */
    ...
    /**
     * Returns an attribute with the values to be added. This is based on the state of this object. If there are no
     * values being added and the "no value" value is defined, the "no value" is included. This ignores any existing
     * attribute values.
     * 
     ...
     * @throws NamingException thrown if a naming error occurs
     */
    ...
    public List<Modification> getDSMLModification() throws DSMLProfileException {
        ...
        if (isReplaceValues()) {
            ...
            if (adds.size() > 0 || deletes.size() > 0) {
                ...
                replace.addAll(retained);
                replace.addAll(adds);

                DSMLModification dsmlMod =
                        new DSMLModification(attributeName, makeDSMLValues(replace), ModificationMode.REPLACE);
    ...
    /**
     * @return Returns the replaceValues.
     */
    ...
    /**
     * @param replaceValues The replaceValues to set.
     */
     ...
     * 
     * @param attributeSet the attribute ValueSet to convert.
    ...
    /**
     * If <tt>caseSensitive</tt> is <tt>true</tt>, return value, otherwise return lowercased value.
     * 
    ...
    /**
     * Implements optional case ignoring set by backing it with a Map, mapping the possibly lowercased values to the
     * actual values.
     */
    public class Values implements Iterable<String> {
         ...
         * 
         * @param value element to be added to the values.
         ...
         * 
         * @param iterable iterable whose elements are to be added to the values.
         ...
         * 
         * @param object element whose presence in the values is to be tested.
         ...
         * 
         * @param value element to be removed from the values, if present.
