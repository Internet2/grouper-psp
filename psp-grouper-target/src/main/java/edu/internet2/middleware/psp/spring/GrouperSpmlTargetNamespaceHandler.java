...
/** Spring namespace handler for the Grouper target namespace. */
public class GrouperSpmlTargetNamespaceHandler extends BaseSpringNamespaceHandler {
    ...
    /** {@inheritDoc} */
    public void init() {
        registerBeanDefinitionParser(GrouperSpmlTargetBeanDefinitionParser.TYPE_NAME,
                new GrouperSpmlTargetBeanDefinitionParser());
    }
}
